...
namespace Automoviles.BO.Controllers
{
    public class SegurosController : Controller
    {
        ...
        public SegurosController(AutoDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Seguro seguro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Seguro seguro)
        {
            if (id != seguro.Id)
            {
                return NotFound();
