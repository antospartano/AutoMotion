...
namespace Automoviles.BO.Controllers
{
    public class VehiculosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ModeloId,PaisId,ColorId,CombustibleId,SeguroId,TipoId,Precio,anio,MarcaId")] Vehiculo vehiculo)
        {
            ...
            ViewData["ModeloId"] = new SelectList(_context.Set<Modelo>(), "Id", "Nombre", vehiculo.ModeloId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ModeloId,PaisId,ColorId,CombustibleId,SeguroId,TipoId,Precio,anio,MarcaId")] Vehiculo vehiculo)
        {
            if (id != vehiculo.Id)
            {
                return NotFound();
