...
namespace Automoviles.BO.Controllers
{
    public class CombustiblesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Combustible combustible)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Combustible combustible)
        {
