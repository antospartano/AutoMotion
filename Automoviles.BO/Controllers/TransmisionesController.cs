...
namespace Automoviles.BO.Controllers
{
    public class TransmisionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Transmision transmision)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Transmision transmision)
        {
